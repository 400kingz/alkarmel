/*
  # Add admins table and update RLS policies
  ...
  2. Security
    ...
    - Add policy for admins to manage the admins table
    - Update products table policies to use admins table instead of metadata
